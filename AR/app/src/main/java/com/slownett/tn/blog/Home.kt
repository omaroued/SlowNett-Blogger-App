...
class Home : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
            ...
            R.id.news -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("أخبار انترنت")) {
            ...
            R.id.exclu -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("حصريات")) {
            ...
            R.id.you -> {
                ...
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("حلقات")) {
            ...
            R.id.android -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("أندرويد")) {
            ...
            R.id.win -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("ويندوز")) {
            ...
            R.id.coding -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("البرمجة")) {
            ...
            R.id.fb -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("الفيسبوك")) {
            ...
            R.id.web -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("مواقع")) {
            ...
            R.id.pro -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("برامج")) {
            ...
            R.id.game -> {
                try {
                    ...
                    for (i in 0..20) {
                        ...
                        if (article.label!!.contains("ألعاب")) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(isNetworkStatusAvialable (getApplicationContext())) {
            val url="https://www.slownett.com/feeds/posts/default?alt=json"
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        ...
        sv.queryHint=" إبحث هنا"
        sv.setPadding(0,0,40,0)
